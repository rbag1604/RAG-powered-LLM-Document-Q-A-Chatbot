...
def process_document(file_path: str) -> List[str]:  # Added type hinting
    """Loads and processes a document, returning texts."""
    try:
        ...
        return [text.page_content for text in texts]  # Extract text content
    except Exception as e:
...
async def upload_document(file: UploadFile = File(...)):
    ...
    try:
        ...
        return {"filename": file.filename, "message": "Document uploaded and processed successfully."}
